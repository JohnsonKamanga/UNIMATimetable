...
export default function ListClassCard({
  ...
  return (
    <div className="flex flex-col gap-y-1 text-xs bg-[#fc506e] text-white rounded-xl border-black border-[1px] border-opacity-35 shadow-xl p-1">
      <div className="flex flex-row bg-white bg-opacity-30 items-center gap-x-1 p-2 border-black border-[1px] border-opacity-25 shadow-xl w-fit rounded-full">
